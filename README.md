# MD to TXT Converter (веб-сервис с мониторингом)
...
- Конвертация Markdown в обычный текст с сохранением структуры (заголовки, списки, ссылки, таблицы и т.д. удаляются, текст остаётся).
